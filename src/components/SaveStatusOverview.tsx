...
interface SaveStatusOverviewProps {
  isVisible: boolean;
  onClose: () => void;
  onShowHistory: () => void;
...
const SaveStatusOverview: React.FC<SaveStatusOverviewProps> = ({ 
  isVisible, 
  onClose, 
  onShowHistory, 
  onShowStatistics, 
  ...
  useEffect(() => {
    if (isVisible) {
      ...
      const interval = setInterval(calculateOverviewData, 10000);
  ...
  const getSuccessRate = () => {
    if (overviewData.totalSaves === 0) return 0;
    return Math.round((overviewData.successfulSaves / overviewData.totalSaves) * 100);
  };
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b">
              <div className="flex items-center space-x-2">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Przegląd zapisów</h2>
              </div>
              <div className="flex items-center space-x-2">
                <button
                  onClick={calculateOverviewData}
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                >
                  <div className="flex items-center space-x-2 mb-2">
                    {getStatusIcon(overviewData.currentStatus)}
                    <h3 className="font-semibold text-gray-800">Status</h3>
                  </div>
                  <div className={`text-2xl font-bold ${getStatusColor(overviewData.currentStatus)}`}>
                    {overviewData.currentStatus === 'saving' ? 'Zapisywanie...' : 
                     overviewData.currentStatus === 'saved' ? 'Zapisano' :
                     overviewData.currentStatus === 'error' ? 'Błąd' : 'Gotowy'}
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className={`text-2xl font-bold ${overviewData.isOnline ? 'text-green-600' : 'text-red-600'}`}>
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-yellow-600">{overviewData.pendingSync}</div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-sm font-medium text-gray-600">
                    {overviewData.lastSaveTime 
                      ? formatLastSaveTime(overviewData.lastSaveTime)
                      : 'Brak danych'
                    }
                  </div>
                </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-blue-600">{overviewData.totalSaves}</div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-purple-600">
                    {formatDuration(overviewData.averageSaveTime)}
                  </div>
                </motion.div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-yellow-600">{overviewData.savesToday}</div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-indigo-600">{overviewData.savesThisWeek}</div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-3xl font-bold text-pink-600">{overviewData.savesThisMonth}</div>
                </motion.div>
              </div>
...
export default SaveStatusOverview;
