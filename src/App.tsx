            ...
            <div className="card relative group">
              ...
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50">
                <div className="relative px-4 py-2 bg-gradient-to-br from-purple-600 to-pink-600 text-white text-sm font-medium rounded-2xl shadow-2xl"
                  ...
                  Brain Nutrition Supplying 🧠 antywegetacja, zachowanie świadomości, skrupulatna weryfikacja "pomysłów na siebie" w celu wielopłaszczyznowego rozwoju osobistego, z różnych perspektyw których limit sięga tam gdzie pragmatyzm ma koniec (hehe), w celu  zmaksymalizowania wydajności, ale i uprawdopodobnianiu (elastycznego) potencjału drzemiącego w samozwańczej elicie łańcucha pokarmowego, do czego rościmy sobie prawa obligatoryjnie, nawet kiedy nie dołożyliśmy cegiełki ni w rozwój ludzkości, czy subiektywnie gorzej, rozwoju duchowym, fizycznym i umysłowym, dzięki którym faktycznie możemy mieć poczucie deklasacji innych gatunków.... nie wiem czy ego niewybuchnie poza kod... nie musze czuć lepszy, bo jestem, nie wiem nawet w ilu dziedzinach. Z poczuciem wyższości ale ciężko pracując dokładając kolejne argumenty i aspekty uzasadniające różnice między mną (i wielu podobnych mnie) z solidnie ugruntowanymi podstawami i "fizycznymi" argumentami za tym przemawiającymi, w kontrze do większości dmuchającej swoje poczucie wartości, bez wkładu w rozwój mentalny, społeczny, techniczny czy jakikolwiek inny, bezpodstawnie stawiając się na czele, (teraz wyjdzie cham) a wegetatywne życie, scrollowanie i lajkowanie w objeciach social mediów, poklask dla chamstwa i głupoty, gloryfikacja patologii, krzywdzenie i sprawdzanie granic moralności, nie plasuje was wyżej niż, wyedukowane powtarzalnością zwierzęta (psy noszące zakupy, czy obdarzone słuchem muzycznym) Ba ! poczytajcie o grzybach, kurwa mamy szczęście, że nie należymy do ich ekoświatka bo wizja bycia pod pasożytniczym wpływem i zniewolenie inmunologiczne jest surrealistyczne (i nie prosto z " The Last of us" tylko https://www.national-geographic.pl/przyroda/grzyby-zombie-w-walce-ze-szkodnikami-polak-w-miedzynarodowym-projekcie-badawczym/) a to tylko ziarnko w cudach natury, o komunikacji roślin też coś czytałem, ich ewolucji w celu przetrwania.... i jest wiecej argumentów popierających wyższości natury, i nie znam podstaw którymi kieruje się ~87% populacji świata, podpinając się pod osiągniecia 13,8 %, mówić o NASZEJ ewolucji, rozwoju i przekraczaniu kolejnych barier. na koniec pozwole sobie to zobrazować dość dosadnie : w królestwie zwierząt, lwy, szakale, mangusty, surykatki, pelikany, pingwiny czy kaczki morskie i inne, selekcją naturalną utrzymują równowage i konkurencyjność, redukcje zachorowań w biomie, zwiększanie szansy przeżycia usuwając ze stada jednostki osłabiające grupę, utrzymanie mobilności i efektywności w grupie porzucając najsłabsze, a i w ten sposób regulują liczebność, dla optymalizacji zasobów. A ludzkości w imie ewolucji, celu ograniczenia chciwej eksploatacji ziemi, jej dóbr naturalnych, mineralnych i energetycznych, itp, dla korzyści materialnych, dopuszcza koncerny przemysłowe na apartheid, predylekując niemoralnym , niezasadnym, nienaturalnym, wyborom przeciwko ewolucji człowieka, świadomie niszcząc niewygodne stada-zgrupowania, dokładając wszelkich starań chciwym inklinacją, tendencyjnie na podstawie irracjonalnych pobudek dokonywać selekcji, w opozycji do jakichkolwiek dowodów, nawet namacalnych, nadrzędnym elementem ewolucji jest pragmatyzm z dozą dystansu do siebie i akceptacją zmian, ale czy to nie byłoby zbyt Utopijne? A może naturalną konsekwencją dobrobytu społecznyego, technologicznego, rozwojowego, następstwem w skutek stagnacji ewolucyjnej może być tylko Destopia w parze z apatią, kończąc cywilizacje, na zgliszczach budując wyrachowaną przyszłość ?  
                  <div className="absolute top-full left-1/2 transform -translate-x-1/2 -mt-1">
